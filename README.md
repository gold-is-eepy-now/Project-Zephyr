...
Zephyr now focuses on **readable page display** instead of showing raw fetch logs or source blobs, with a Chromium-inspired Win32 shell (tab strip + navigation toolbar + omnibox + status bar).
